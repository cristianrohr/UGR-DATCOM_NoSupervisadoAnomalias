...
# uni.plot obtiene los outliers calculando las distancias de Mahalanobis y usando la aproximaci?n
# de la Chi cuadrado
# La estimaci?n de la matriz de covarianzas es la estimaci?n robusta seg?n MCD (minimum covariance determinant)
...
# Accedemos a uni.plot$outliers para obtener los ?ndices de los outliers
...
# Calculamos los ?ndices de los outliers multivariantes en la variable 
...
# Esta funci?n la tuvo que definir en el apartado de Ampliaci?n del fichero B1
...
indices.de.outliers.multivariantes.MCD.pero.no.1variantes <- setdiff(indices.de.outliers.en.alguna.columna,
                                                                     indices.de.outliers.multivariantes.MCD)
...
# COMPLETAR
indice.ferrari.dino <- which(row.names(mydata.numeric) == "Ferrari Dino")
MiPlot_Univariate_Outliers(mydata.numeric, indice.ferrari.dino, "Ferrari dino")
